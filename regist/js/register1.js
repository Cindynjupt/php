 ...
 */
    ...
    function commitReg1(){
     ...
     $.ajax({
       url: "../commit_reg1",
       type: "post",
       data: {'telephone':telephone,'md5pwd':md5pwd,'university':university},
       cache: 'false',
       dataType: "json",
       async: 'true',
       success: function(data) {
...
function check_telephone_unique2(telephone){
 $.ajax({
   url: "../check_telephone",
   type: "post",
   data: {'telephone':telephone},
...
//alert('flag : ' + flag);
 ...
 if(flag){
  ...
  $.ajax({
   url: "./commit_regist",
   type: "post",
   data: {'realname':realname,'username':username,'sex':sex,'birthday':birthday,
